              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-medium text-green-700 dark:text-green-300">🟢 {t('alwaysOn')}</div>
                ...
                >
                  ...
                  />
                  <div className="flex-1">
                    <div className="font-medium text-gray-700 dark:text-gray-300">🌙 {t('outsideHours')}</div>
                    <p className="text-sm text-muted-foreground mt-1">
                      {t('outsideHoursDesc')}
                    </p>
                  </div>
                ...
                >
                  ...
                  />
                  <div className="flex-1">
                    <div className="font-medium text-gray-700 dark:text-gray-300">☀️ {t('duringHours')}</div>
                    <p className="text-sm text-muted-foreground mt-1">
                      {t('duringHoursDesc')}
                    </p>
                  </div>
